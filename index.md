...
|-------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| [`ptrap_de()`](https://laurenoconnelllab.github.io/pTRAPPING/reference/ptrap_de.md)             | IP vs INPUT DE analysis for TRAP-seq (edgeR LRT/QLF or paired t-test)                                                 |
...
| [`limma_de()`](https://laurenoconnelllab.github.io/pTRAPPING/reference/limma_de.md)             | Multi-group DE for proteomics / metabolomics (limma `treat` or `eBayes`)                                              |
