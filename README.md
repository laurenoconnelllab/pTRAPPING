...
Plot the same results in a volcano plot and annotate any genes of
interest:
...
to see how to run the full workflow, including comparing two conditions
head-to-head and making interactive volcano plots!
...
> edgeR: Robinson, M.D., McCarthy, D.J., and Smyth, G.K. (2010). edgeR:
...
> limma: Ritchie, M.E., Phipson, B., Wu, D., Hu, Y., Law, C.W., Shi, W.,
> and Smyth, G.K. (2015). limma powers differential expression analyses
