...
Check [Getting started with pTRAPPING](https://laurenoconnelllab.github.io/pTRAPPING/articles/getting-started.html) to see how to run the full workflow, including comparing two conditions head-to-head and making interactive volcano plots!
