...
**pTRAPPING** provides a streamlined, reproducible workflow
...
the function which group to analyse: 1
...
```{r volcano-voom, fig.alt = "Volcano plot from limma-voom analysis"}
ptrap_volcano(
  res_nb_voom,
...
```{r volcano-unpaired, fig.alt = "Volcano plot from unpaired t-test comparing pb vs nb"}
ptrap_volcano(
  res_unpaired,
